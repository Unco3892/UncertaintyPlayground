...
class SparseGPTrainer:
    def __init__(self, X, y, sample_weights=None, num_inducing_points=100, test_size=0.2, random_state=42, num_epochs=50, batch_size=256, optimizer_fn_name="Adam", lr=0.01, use_scheduler=False, patience=10, dtype=torch.float32):
        self.X = X
        self.y = y
...
# gpr_mod= SparseGPTrainer(r.X_train, r.y_train, num_inducing_points = 200, num_epochs=5000, batch_size=1000, lr=0.2,patience = 3,)
# gpr_mod.train()
